...
function redirectTo(path) {
  const localDomains = ["localhost", "127.0.0.1", "192.168.x.x", "10.x.x.x", "https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2023-1-e1-proj-web-t2-grupo-1-assistencia-residencial"];
